...
public class ReportBuilder {
	...
	private final static Logger LOGGER = Logger.getLogger(ReportBuilder.class .getName());
    ...
    private void copyResource(String resourceLocation, String resourceName) throws IOException, URISyntaxException {
    	LOGGER.log(Level.INFO, String.format("copyResource location: %s, resourceName: %s", resourceLocation, resourceName));
        ...
        if (resourceArchiveInputStream == null) {
			...
			resourceArchiveInputStream = ReportBuilder.class.getResourceAsStream(resourcePath);
            if(resourceArchiveInputStream == null){
